...
export type IconName = 'film' | 'home' | 'hard-drive' | 'wifi' | 'warning' | 'check';
export type StatusType = 'operational' | 'degraded' | 'down' | 'loading';
...
const loadedIcons = shallowRef(new Map<string, string>());
